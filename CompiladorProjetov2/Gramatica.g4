...
tipo       : 'numero' { _tipo = GramaticaVariavel.NUMBER;  }
           | 'texto'  { _tipo = GramaticaVariavel.TEXT;  }
           ;
...
cmd		:  cmdleitura  { System.out.println(" Reconhecido um comando de leitura");	    }
 		...
 		|  cmdselecao
 		|  cmdreturn
 		|  cmdboolean   { System.out.println(" Reconhecido um comando booleano");	}
		;
...
cmdboolean  :   'bool' ID { verificaID(_varName = _input.LT(-1).getText());}
                 ATTR (TRUE | FALSE) SC
            ;
